...
\begin{document}
	...
	\section{Решение двумерного уравнения Лапласа}
		...
		\section{Примеры решения задачи}
			...
			\begin{figure*}[!h]
				\centering
				\includegraphics[width=0.8\textwidth]{rect_dirichlet_only_005.png}
				\caption{Численное решение задачи №\,1 с разбиением области $\Omega$ с параметром $MaxCellMeasure \rightarrow 0.05$}
			...
			\begin{table}[!h]
				\centering
				\caption{\label{table_comparison_005} Сравнение значений точного решения и численного решения с разбиением области $\Omega$ с параметром $MaxCellMeasure \rightarrow 0.05$  задачи №\,1}
				\vspace*{2mm}
			...
			\noindent
			Среднее значение абсолютной погрешности: 	0.2409948.\\
			Среднее значение относительной погрешности: 0.14326178.
			...
			\begin{figure*}[!h]
				\centering
				\includegraphics[width=0.8\textwidth]{rect_dirichlet_only_001.png}
			...
			\begin{table}[!h]
				\centering
				\caption{\label{table_comparison_001} Сравнение значений точного решения и численного решения с разбиением области $\Omega$ с параметром $MaxCellMeasure \rightarrow 0.01$  задачи №\,1}
				\vspace*{2mm}
				\begin{tabular}{|c|c|c|c|c|c|}
					\hline
					Узел №
