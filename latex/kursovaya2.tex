...
\begin{document}
	...
	\section{Решение двумерного уравнения Лапласа}
		...
		\section{Примеры решения задачи}
			...
			\begin{figure*}[!h]
				\centering
				\includegraphics[width=0.8\textwidth]{rect_dirichlet_only_005_calfem.png}
			...
			\begin{figure*}[!h]
				\centering
				\includegraphics[width=0.8\textwidth]{rect_dirichlet_only_0001_calfem.png}
				\caption{Численное решение задачи №\,1 с разбиением области $\Omega$ с параметром $MaxCellMeasure \rightarrow 0.01$}
			...
			\begin{table}[!h]
				\centering
				\caption{\label{table_comparison_0001} Сравнение значений точного решения и численного решения с разбиением области $\Omega$ с параметром $MaxCellMeasure \rightarrow 0.01$  задачи №\,1}
				\vspace*{2mm}
				\begin{tabular}{|c|c|c|c|c|c|}
					\hline
					Узел №
	...
	\begin{table}[!h]
		\centering
		\caption{\label{table_comparison} Сводная таблица задачи №\,1}
		\vspace*{2mm}
