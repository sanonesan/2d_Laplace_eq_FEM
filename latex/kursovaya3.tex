...
\begin{document}
	...
	\section{Решение двумерного уравнения Лапласа}
		...
		\section{Примеры решения задачи}
	 	...
	 	\looser{0.0115}{где 
	 		...
	 		$S_i$ --- площадь $i$-ого конечного элемента, $N_v$ --- количество узлов конечного элемента, $u_{exact,\,ij},\ u_{approx,\,ij}$ --- точное и приближенное значения решения в $j$-ом узле $i$-ого элемента, $\phi_{ik}$ --- базисная функция в $k$-ом узле $i$-ого кочечного элемента.} 
		...
		\subsubsection{Погрешность аппроксимации на сетках}
			...
			\begin{table}[!h]
				...
				\begin{tabular}{|c|c|c|c|c|}
					...
					& \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}c@{}}Погрешность \\ решения\\ в норме $L_2$\end{tabular}} \\
		...
		%	\end{figure*}
			...
			На этапе построения сетки видно, что, в отличие от CALFEM, где соотношение среднее отношение большего и меньшего ребер конечного элемента 
			$\dfrac{h_{max}}{h_{min}}\approx 1$, сетка в Wolfram Mathematica выходит менее структурированной, для нее среднее отношение большего и меньшего ребер $\dfrac{h_{max}}{h_{min}}\approx 1.4$. 
			...
			\begin{table}[!h]
				...
				\begin{tabular}{|c|c|c|c|c|}
					...
					\begin{tabular}[c]{@{}c@{}}Средняя длина\\ ребра $h$\\ конечного элемента\end{tabular} 
			...
			Как видно из рисунков \ref{fig: max_err_005}--\ref{fig: max_err_0001} большая погрешность аппроксимации возникает в приграничных областях, где заданы разные значения на границах. Так же видно, что на сетке с большим отношением  $\mathrm{avg} \left( \dfrac{h_{max}}{h_{min}} \right) $ ошибка <<проникает>> глубже внутрь области, чем на сетке с меньшим $\mathrm{avg} \left( \dfrac{h_{max}}{h_{min}} \right) $. 
	...
	\begin{thebibliography}{4}
		...
		\bibitem{Landau} Ландау Л.Д., Лифшиц Е.М. Теория поля. -- 6-е изд., испр. -- Москва : Издательство Наука, 1973. 507 с.
