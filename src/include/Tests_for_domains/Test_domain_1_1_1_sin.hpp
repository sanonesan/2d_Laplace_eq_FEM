...
*/
template<class T>
class Test_domain_1_1_1_sin: virtual public Class_2d_Laplace_equation<T>{

    public:

        Test_domain_1_1_1_sin(){            
            //test name
            //this->_name = std::string (__func__);
            this->_name = std::string ("Test_domain_1_1_1_sin_mesh_001");
            ...
            this->Set_domain(*this, "../domains/domain_1_1_1/mesh001");
        }


        // Test_domain_1_1_1_sin<T> Set_mesh_01(){
        ...
        // Test_domain_1_1_1_sin<T> Set_mesh_005(){
        ...
        Test_domain_1_1_1_sin<T> Set_mesh_001(){
        ...
        // Test_domain_1_1_1_sin<T> Set_mesh_0001(){
